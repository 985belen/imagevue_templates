...
if (!defined('IS_MOBILE')) define('IS_MOBILE',
	...
	|| false !== stripos($_SERVER['HTTP_USER_AGENT'], 'bada')
	|| false !== stripos($_SERVER['HTTP_USER_AGENT'], 'blackberry')
	|| false !== stripos($_SERVER['HTTP_USER_AGENT'], 'phone os')
	|| false !== stripos($_SERVER['HTTP_USER_AGENT'], 'mobile')
);
...
require_once(INCLUDE_DIR . 'ivFileFlv.class.php');
